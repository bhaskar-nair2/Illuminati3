...
angular.module('sweaApp')
	.controller('globalCtrl', function ($rootScope, $location, $http, $routeParams) {
		...
		$rootScope.getAdminData = function () {
			$http({
				method: 'GET',
				url: $rootScope.apiUrl + 'team/adminGet',
				params: {
...
angular.module('sweaApp')
	.controller('loginCtrl', function ($scope, $http, $location, $rootScope) {
		...
		$scope.loginAdmin = function () {
			$http({
				method: 'POST',
				url: $rootScope.apiUrl + 'team/adminLogin',
				data: $scope.admin
			}).then(function (res) {
				if (res.data.status == true) {
	...
	.controller('homeCtrl', function ($scope, $http, $rootScope, $window, $timeout) {
		...
		$scope.deleteTeam = function () {
			swal({
				...
				$http({
					method: 'POST',
					url: $rootScope.apiUrl + 'team/deleteTeam',
					data: {
						adminKey: $rootScope.adminKey,
		...
		$scope.sendStatus = function () {
			$http({
				method: 'POST',
				url: $rootScope.apiUrl + 'team/sendStatus',
				data: {
					adminKey: $rootScope.adminKey,
					teamId: $scope.teamData.teamId
				}
		...
		$scope.addPayment = function () {
			swal({
				...
				swal({
					...
					$http({
						method: 'POST',
						url: $rootScope.apiUrl + 'team/paymentHandler',
						data: {
							adminKey: $rootScope.adminKey,
							teamId: $scope.teamData.teamId,
							money: result
		...
		$scope.changeTransactionStatus = function (tid) {
			swal({
				...
				$http({
					method: 'POST',
					url: $rootScope.apiUrl + 'team/changeTransactionStatus',
					data: {
						adminKey: $rootScope.adminKey,
						teamId: $scope.teamData.teamId,
						tid: tid,
